...
class MazeGame:
    ...
    def handle_success(self):
        ...
        # Reset position but keep the same maze for additional training
        print("\nResetting position for additional training...")
        self.character_pos = self.start
        ...
        print(f"Adjusted epsilon to: {self.agent.epsilon:.3f}")
